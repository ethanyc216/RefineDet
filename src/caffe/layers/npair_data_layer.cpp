...
#include "caffe/layers/npair_data_layer.hpp"
...
vector<pair<string, int> > NPairDataLayer<Dtype>::RandLeafImages(int leaf_label, int rand_image_num) {
...
template <typename Dtype>
NPairDataLayer<Dtype>::~NPairDataLayer<Dtype>() {
  // this->JoinPrefetchThread();
  this->StopInternalThread();
}

template <typename Dtype>
void NPairDataLayer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
...
template<typename Dtype>
void NPairDataLayer<Dtype>::ShuffleLeafs() {
...
template<typename Dtype>
void NPairDataLayer<Dtype>::ShuffleImages(int leaf_label) {
  caffe::rng_t* prefetch_rng =
    static_cast<caffe::rng_t*>(prefetch_rng_->generator());
...
template <typename Dtype>
void NPairDataLayer<Dtype>::load_batch(Batch<Dtype>* batch) {
...
INSTANTIATE_CLASS(NPairDataLayer);
REGISTER_LAYER_CLASS(NPairData);
