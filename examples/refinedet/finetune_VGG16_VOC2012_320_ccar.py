...
train_data = "/home/fzhou/data/ccar/lmdb/ccar_train_lmdb"
# The database file for testing data. Created by data/VOC0712Plus/create_data.sh
test_data = "/home/fzhou/data/ccar/lmdb/ccar_val_lmdb"
...
save_dir = "models/VGGNet/ccar/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/ccar/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/ccar/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/RefineDet/pascal/VOCdevkit/results/VOC2012/{}/Main".format(os.environ['HOME'], job_name)
...
name_size_file = "data/ccar/test_name_size.txt"
# The pretrained model. We use the RefineDet model trained on coco dataset.
pretrain_model = "models/VGGNet/VOC0712Plus_refinedet_vgg16_320x320_ft_final.caffemodel"
# Stores LabelMapItem.
label_map_file = "data/ccar/labelmap_ccar.prototxt"
