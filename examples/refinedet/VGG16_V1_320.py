...
test_data = "examples/v1/v1_minival_lmdb"
...
model_name = "v1_{}".format(job_name)
...
output_result_dir = "{}/data/RefineDet/v1/results/{}".format(os.environ['HOME'], job_name)
