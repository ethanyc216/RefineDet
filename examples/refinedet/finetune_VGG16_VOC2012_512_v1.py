...
save_dir = "models/VGGNet/v1/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/v1/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/v1/{}".format(job_name)
...
name_size_file = "data/v1/test_name_size.txt"
...
# Stores LabelMapItem.
label_map_file = "data/v1/labelmap_v1.prototxt"
