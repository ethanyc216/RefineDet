...
train_data = "examples/ccar/ccar_train_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "examples/ccar/ccar_val_lmdb"
...
model_name = "ccar_{}".format(job_name)
...
name_size_file = "data/ccar/val2017_name_size.txt"
# The pretrained model. We use the RefineDet model trained on coco dataset.
pretrain_model = "models/VGGNet/coco/refinedet_vgg16_320x320/coco_refinedet_vgg16_320x320_final.caffemodel"
# Stores LabelMapItem.
